# Generated by Django 4.2.6 on 2024-08-10 02:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notification_type', multiselectfield.db.fields.MultiSelectField(choices=[('GIG_TRANSFER', 'Gig Transfer'), ('VENUE_ADVERTISED_GIG', 'Venue Advertised Gig'), ('GENERAL_GIGSWEEP_UPDATES', 'General Gigsweep Updates'), ('TEST', 'Test')], max_length=200)),
                ('if_gig_advertised_by_artist', models.IntegerField(blank=True, null=True)),
                ('if_venue_made_gig', models.IntegerField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', multiselectfield.db.fields.MultiSelectField(blank=True, choices=[('Active', 'Active'), ('Transferred', 'Transferred'), ('Past', 'Past')], default=('Active',), max_length=200)),
                ('artist', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='gigsweep_django_backend.artist')),
                ('artist_gig', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='applications', to='gigsweep_django_backend.artistlistedgig')),
                ('original_artist', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='original_gig_applications', to='gigsweep_django_backend.artist')),
                ('venue', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='gigsweep_django_backend.venue')),
            ],
        ),
    ]
